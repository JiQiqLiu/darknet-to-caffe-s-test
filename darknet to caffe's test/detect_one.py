...
def main():
    ...
    print mapping
    scaling_factor=args.resolution / img_ori.shape[1]
    #scaling_factor = min(1, args.resolution / img_ori.shape[1])#args.resolution 418 img_ori.shape[1] 602
